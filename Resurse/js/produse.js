...
//     //bifare elemente din cosul virtual (localStorage) ?????dc nu raman bifate
...
//document.querySelectorAll(".select-cos")    -> selectare dupa clasa
    ...
    document.getElementById("filtrare").onclick=function(){
        ...
        // var valInaltime = parseInt(document.getElementById("id_list").innerHTML);
        ...
        for( let art of articole){
            ...
            // let dimensiuniArt = parseInt(art.getElementsByClassName("val-dimensiuni")[0].innerHTML);
            //cond7 este true daca valDimensiuni(input) >= dimensiunea articolului
 ...
 //---------------------------------------------------resetare-----------------------------------------------
    document.getElementById("resetare").onclick = function(){
        ...
        // document.getElementsById("i_datalist").value="";
